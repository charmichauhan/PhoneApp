        ...
        <Row>
          <Col style={{marginLeft:'70px'}} xs="10">
            <InputGroup>
              ...
              <InputGroupButton>
                <Button
                  disabled={this.props.input.name.length < 2 || this.props.input.lastname.length < 2 || this.props.activeObject.phonenumber.length < 10 ||  !new RegExp(/^\d+$/).test(this.props.input.phonenumber)}
                  color="primary"
                  onClick={() => {
